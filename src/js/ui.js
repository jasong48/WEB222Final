...
function toggleLoading(isLoading) {
  ...
  if (isLoading == true) {
    document.getElementById("enterSearch").disable = true;
    const myicon = document.createElement("i");
    myicon.classList.add("fas", "fa-hourglass-half");
    document.getElementById("enterSearch").innerHTML = "Loading...";
    document.getElementById("enterSearch").appendChild(myicon);
  }
  if (isLoading == false) {
    document.getElementById("enterSearch").disable = false;
    const myicon = document.createElement("i");
    myicon.classList.add("fas", "fa-search");
    document.getElementById("enterSearch").innerHTML = "Search ";
    document.getElementById("enterSearch").appendChild(myicon);
  }
